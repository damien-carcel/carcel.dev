...
- `task run:dev` for development mode with hot-reload and access it through [http://localhost:3000](http://localhost:3000).
- `task run:prod` for production-like mode and access it through [http://localhost:8000](http://localhost:8000).
